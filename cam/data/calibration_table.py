...
if __name__ == '__main__':
    ...
    if True:
        ...
        np.savetxt('/home/zcs/work/github/folding-by-hand/calibration/cam2table_depth_scale1.txt',
                   camera_depth_offset, delimiter=' ')
        get_rigid_transform_error(camera_depth_offset)
        camera_pose = np.linalg.inv(world2camera)
        np.savetxt('/home/zcs/work/github/folding-by-hand/calibration/cam2table_pose_3.txt',
